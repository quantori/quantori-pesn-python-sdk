...
class Library(BaseMaterialEntity):
    ...
    def dump(self, base_path: str, fs_handler: FSHandler, base_alias: Tuple[str]):
        metadata = {
        ...
        try:
            ...
            fs_handler.write(fs_handler.join_path(base_path, self.eid, file_name), data, base_alias + (metadata['name'], file_name))
